...
public class IfBlockParserTest {
    ...
    private static void parseIfBlock(@Nonnull String code, @Nonnull Matcher<? super ParseError> blockParseErrorMatcher,
        ...
        for (int i = 0; i < childNodes.size(); i++) {
            ...
            assertThat(childNode, hasType((i & 1) == 0 ? TestBlockDirectiveLine.class : SimpleCompositeSourceNode.class));
        }
    }

    /**
     * Asserts that {@link IfBlockParser#parseBlock(SourceNodeProducer, BlockDirectiveLine)} correctly parses a complete
    ...
    /**
     * Asserts that {@link IfBlockParser#parseBlock(SourceNodeProducer, BlockDirectiveLine)} correctly parses an incomplete
     * <code>IF</code> block.
     */
    @Test
