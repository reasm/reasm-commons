...
/**
 * A <code>BLOCK1</code> block.
 *
 * @author Francis Gagné
 */
@Immutable
public final class Block1Block extends CompositeSourceNode {

    /**
     * Initializes a new Block1Block.
     *
     * @param childNodes
     *            the child nodes
     * @param parseError
     ...
     */
    public Block1Block(@Nonnull Iterable<? extends SourceNode> childNodes, @CheckForNull ParseError parseError) {
