...
import org.reasm.commons.testhelpers.EquivalentLogicalLine;
import org.reasm.commons.testhelpers.EquivalentParseError;
...
public class ReparserSourceNodeProducerTest {
    ...
    private static final class RecycledSourceNodeMatcher extends SourceNodeMatcher {
        ...
        public RecycledSourceNodeMatcher(@Nonnull int[] indices) {
    ...
    private static final Parser PARSER = TestParser.TEST_PARSER;
    ...
    static {
        ...
        final SubstringBounds bounds_1_7 = bounds(1, 7);
        final SubstringBounds bounds_1_10 = bounds(1, 10);
        final SubstringBounds bounds_11_13 = bounds(11, 13);
        final SubstringBounds[] array_bounds_8_9 = array(bounds(8, 9));
        ...
        final SourceNodeMatcher block0Directive2 = blockDirectiveLine(logicalLine(10, null, NO_LABELS, bounds_1_7,
                array_bounds_8_9, null, NO_CONTINUATION_CHARACTERS));
        ...
        // Alter a line before a BLOCK0 block
        addDataItem(" NOT\n BLOCK0 1\n MOVE #0,D0\n ENDBLOCK0\n NOP", 3, 1, "P", " NOP\n BLOCK0 1\n MOVE #0,D0\n ENDBLOCK0\n NOP",
                composite(Block.class, nopPlusLF, recycled_1, recycled_2));

        // Alter a BLOCK0 directive
        addDataItem(
                " NOP\n BLOCK0 0\n MOVE #0,D0\n ENDBLOCK0\n NOP",
                13,
                1,
                ...
                composite(
                        Block.class,
                        recycled_0,
                        composite(Block0Block.class, block0Directive2, composite(SimpleCompositeSourceNode.class, recycled_1_1_0),
                                recycled_1_2), recycled_2));

        // Alter a line within a BLOCK0 block
        addDataItem(
                " NOP\n BLOCK0 1\n MOVE #0,D0\n ENDBLOCK0\n NOP",
                22,
                1,
        ...
        addDataItem(
                ...
                composite(
                        ...
                        composite(
                                ...
                                blockDirectiveLine(logicalLine(22, null, NO_LABELS, bounds_1_10, NO_OPERANDS, bounds(11, 21),
                                        NO_CONTINUATION_CHARACTERS))), recycled_2));

        // Alter a line after a BLOCK0 block
        addDataItem(" NOP\n BLOCK0 1\n MOVE #0,D0\n ENDBLOCK0\n NOT", 41, 1, "P", " NOP\n BLOCK0 1\n MOVE #0,D0\n ENDBLOCK0\n NOP",
        ...
        addDataItem(
                ...
                composite(
                        Block.class,
                        recycled_0,
                        composite(Block0Block.class, new UnclosedBlockParseError(TestParser.BLOCK0), block0Directive2,
        ...
        addDataItem(
                ...
                composite(
                        ...
                        composite(
                                ...
                                recycled_1_0,
                                composite(SimpleCompositeSourceNode.class, recycled_1_1_0),
                                blockDirectiveLine(logicalLine(11, null, NO_LABELS, bounds_1_10, NO_OPERANDS, null,
    ...
    @Nonnull
    @SafeVarargs
    private static <T> T[] array(@Nonnull T... items) {
        return items;
    }

    @Nonnull
    private static SourceNodeMatcher blockDirectiveLine(@Nonnull LogicalLineMatcher logicalLineMatcher) {
    ...
    @Nonnull
    private static SourceNodeMatcher composite(@Nonnull Class<? extends CompositeSourceNode> clazz,
            @CheckForNull ParseError parseError, @Nonnull SourceNodeMatcher... childrenMatchers) {
        return new CompositeSourceNodeMatcher(clazz, parseError, ImmutableList.copyOf(childrenMatchers));
    }

    @Nonnull
    private static SourceNodeMatcher composite(@Nonnull Class<? extends CompositeSourceNode> clazz,
            @Nonnull SourceNodeMatcher... childrenMatchers) {
    ...
    private static LogicalLineMatcher logicalLine(int length, @CheckForNull ParseError parseError,
        ...
        return new LogicalLineMatcher(new EquivalentLogicalLine(
                TestLogicalLineFactory.INSTANCE.createLogicalLine(new LogicalLineAttributes(length, parseError, labels, mnemonic,
                        operands, comment, continuationCharacters))));
    }

    @Nonnull
    private static SourceNodeMatcher recycled(@Nonnull int... indices) {
        return new RecycledSourceNodeMatcher(indices);
    }
    ...
    public void next() {
        ...
        final ReparserSourceNodeProducer sourceNodeProducer = new ReparserSourceNodeProducer(PARSER,
                new DocumentReader(newDocument), oldNode, this.replaceOffset, this.lengthToRemove, this.textToInsert.length());
