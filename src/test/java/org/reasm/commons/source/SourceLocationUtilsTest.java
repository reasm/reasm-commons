...
import org.reasm.commons.testhelpers.TestArchitecture;
...
public class SourceLocationUtilsTest {
    ...
    @Nonnull
    private static final SourceFile SOURCE_FILE_D = new SourceFile(" BLOCK0 0\n ENDBLOCK0", "");
    @Nonnull
    private static final SourceLocation SOURCE_LOCATION_BLOCK = SOURCE_FILE_A.getSourceLocations(TestArchitecture.INSTANCE).get(0);
    @Nonnull
    private static final SourceLocation SOURCE_LOCATION_A = SOURCE_FILE_A.getSourceLocations(TestArchitecture.INSTANCE).get(0)
            .getChildSourceLocations().get(0);
    @Nonnull
    private static final SourceLocation SOURCE_LOCATION_B = SOURCE_FILE_B.getSourceLocations(TestArchitecture.INSTANCE).get(0)
            .getChildSourceLocations().get(0);
    @Nonnull
    private static final SourceLocation SOURCE_LOCATION_C = SOURCE_FILE_C.getSourceLocations(TestArchitecture.INSTANCE).get(0)
            .getChildSourceLocations().get(0);
    @Nonnull
    private static final SourceLocation SOURCE_LOCATION_D = SOURCE_FILE_D.getSourceLocations(TestArchitecture.INSTANCE).get(0)
    ...
    public void getLogicalLineBlockDirectiveLine() {
        assumeThat(SOURCE_LOCATION_D.getSourceNode(), hasType(TestBlockDirectiveLine.class));
