...
public final class EquivalentLogicalLine extends TypeSafeDiagnosingMatcher<LogicalLine> {
    ...
    public final void describeTo(Description description) {
        description.appendText("a logical line of type ");
        description.appendValue(this.expectedValue.getClass());
        description.appendText(" with these properties:");
    ...
    public final boolean matchesSafely(LogicalLine item, Description mismatchDescription) {
        return this.matchesProperty("class", item, mismatchDescription)
                && this.matchesProperty("length", item, mismatchDescription) && this.matchesParseError(item, mismatchDescription)
    ...
    private final void describeContinuationCharacters(@Nonnull Description description) {
    ...
    private final void describeLabels(@Nonnull Description description) {
    ...
    private final void describeOperands(@Nonnull Description description) {
    ...
    private final boolean matchesContinuationCharacters(@Nonnull LogicalLine item, @Nonnull Description mismatchDescription) {
    ...
    private final boolean matchesLabels(@Nonnull LogicalLine item, @Nonnull Description mismatchDescription) {
    ...
    private final boolean matchesOperands(@Nonnull LogicalLine item, @Nonnull Description mismatchDescription) {
    ...
    private final boolean matchesParseError(@Nonnull LogicalLine item, @Nonnull Description mismatchDescription) {
